...
def render_scene(scene):
    ...
    renderer.filepath = rootDir + "voxblender/renderingImg/multiThrLoadGlbTest.png"
...
print("multiThrLoadGlbTest sys begin ...")
...
while thread.is_alive():
    ...
    time.sleep(0.1)
    #
print("multiThrLoadGlbTest sys end ...")
# D:\programs\blender\blender.exe -b -P .\multiThrLoadGlbTest.py